...
public class MovieDAOImpl extends DAOBase implements MovieDAO{
	...
	public void insertMovie(Movie movie) {
		try {
			...
			ps.setString(2, movie.getChName());
			ps.setString(3, movie.getOriginName());
			ps.setString(4, movie.getOtherName());
			ps.setString(5, movie.getPoster());
			ps.setString(6, movie.getReleaseDate());
			ps.setString(7, movie.getTimeLength());
			ps.setString(8, movie.getPlot());
			ps.setString(9, movie.getIMDb());
			ps.setString(10, movie.getWebsite());
			ps.executeUpdate();
